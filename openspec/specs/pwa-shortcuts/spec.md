# pwa-shortcuts Specification

## Purpose
Launcher (PWA/WebAPK) shortcuts to the entries the user reaches most often, so each
is one press away instead of several screens deep.
